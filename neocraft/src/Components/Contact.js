...
export default function Contact() {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/asif-abbas-10260a213/",
      icon: (
    ...
    {
      name: "GitHub",
      url: "https://github.com/bluerabbit14",
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="contact-content">
          ...
          <motion.div className="contact-form-container" variants={formVariants}>
            <div className="form-card">
              ...
              <p className="form-description">Tell me about your project and I'll get back to you within 24 hours</p>
